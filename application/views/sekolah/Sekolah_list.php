        ...
        <div class="box box-primary">
            ...
            <form action="<?php echo $action; ?>" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="npsn_sekolah" id="npsn_sekolah" placeholder="NPSN Sekolah" value="<?= set_value('npsn_sekolah') ?>" required/>
                </div>
                <div class="form-group">
                    <label for="varchar">Nama Asal Sekolah <span style="color:red;">*</span></label>
                    <input type="text" class="form-control" name="asal_sekolah" id="asal_sekolah" placeholder="Nama Asal Sekolah" value="<?= set_value('asal_sekolah') ?>" required/>
                </div>
                <div class="form-group">
                    <label for="varchar">Alamat Sekolah</label>
                    <input type="text" class="form-control" name="alamat_sekolah" id="alamat_sekolah" placeholder="Alamat Sekolah" value="<?= set_value('alamat_sekolah') ?>" />
                </div>
                <div class="form-group">
                    <label for="varchar">Kelurahan</label>
                    <input type="text" class="form-control" name="kelurahan" id="kelurahan" placeholder="Kelurahan" value="<?= set_value('kelurahan') ?>" />
                </div>
                <div class="form-group">
                    ...
                    <select type="text" class="form-control" name="status_sekolah" id="status_sekolah" placeholder="Status Sekolah" value="" required/>
                        <option value="<?= set_value('status_sekolah') ?>"><?= set_value('status_sekolah') ?></option>
                        <option value="-">-</option>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="kecamatan" id="kecamatan" placeholder="Kecamatan" value="<?= set_value('kecamatan') ?>" required/>
                </div>
        ...
        <div class="row">            
            <form action="sekolah/upload" method="post" enctype="multipart/form-data">
                <div class="col-xs-12 col-md-12">
                    <div class="form-group">
                        <a href="https://referensi.data.kemdikbud.go.id/pendidikan/dikdas" target="blank"  class="btn bg-aqua btn-flat"><i class="fas fa-link"></i><span class="hidden-xs">&nbsp;&nbsp;Data Referensi Sekolah</span></a>
                        <a href="<?php echo base_url("assets/uploads/files/formatsekolah.xlsx"); ?>" class="btn bg-navy btn-flat"><i class="fas fa-download"></i><span class="hidden-xs">&nbsp;&nbsp;Templete Sekolah</span></a>
                    </div>
                    <div class="form-group">
