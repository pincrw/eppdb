...
<script type="text/javascript">
    ...
    var t = $("#mytable").DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "prestasipeserta/json", "type": "POST"},
                    columns: [
                         {
                            "data": "id_prestasipeserta",
                            "orderable": false,
                        ...
                        },
                        {
                            ...
                            {"data": "tingkat"},
                            {"data": "kategori"},
                            {"data": "juara","className" : "text-center"},
                            {"data": "skor_prestasi","className" : "text-center"},                            
                        {
                            "data" : "action",
                            "orderable": false,
                            "className" : "text-center"
                 ...
                 $("#myform").on('submit', function(e){
                    ...
                    if(rowsel.join(",") == ""){
                        ...
                        var prompt =  alertify.confirm('Apakah anda yakin akan menghapus data tersebut?', 'Apakah anda yakin akan menghapus data tersebut?').set('labels', {ok:'Yakin', cancel:'Batal'}).set('onok',function(closeEvent){
                            $.ajax({
                                url: "prestasipeserta/deletebulk",
                                type: "post",
