            ...
            <form action="<?php echo $action; ?>" role="form" method="post" accept-charset="utf-8">
              ...
              <div id="smartwizard">
                  <ul>
                      ...
                      <li><a href="#step-5">Step 5<br /><small>Data Kontak</small></a></li>
                      <li><a href="#step-6">Step 6<br /><small>Data Priodik</small></a></li>                      
                  <?php if ($formulir->nilai_usbn=='Ya' || $formulir->nilai_rapor=='Ya' || $formulir->nilai_unbk_unkp=='Ya'){ ?>       
                      <li><a href="#step-7">Step 7<br /><small>Data Nilai</small></a></li>
                      <li><a href="#step-8">Step 8<br /><small>Konfirmasi Data</small></a></li>
                  <?php } else { ?>   
                  ...
                  <div>
                      ...
                      <div id="step-2">
                          ...
                          <?php if ($formulir->no_peserta_ujian=='Ya'){ ?>
                            <div class="form-group">
                                  <label for="varchar">No Peserta Ujian <span style="color:red;">*</span> <?php echo form_error('no_un') ?></label>
                                  <input type="text" class="form-control" name="no_un" id="no_un" value="<?= set_value('no_un') ?>" placeholder="No Peserta Ujian" required/>
                            </div>
                          <?php } else { ?>
                                <input type="hidden" class="form-control" name="no_un" id="no_un" />
                          <?php } ?>
