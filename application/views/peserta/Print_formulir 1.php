...
<?php } ?>
	...
	<table>    
		<tr>	
		    ...
		    if ($kode=="D" || $kode=="L") { ?>
		    	<td style="text-align: center;border-top: solid;border-bottom: solid;border-left: solid;border-right: solid">FPD-<?php echo substr($peserta->no_pendaftaran,-1) ?> <?php echo $peserta->ket ?></td>
		    <?php } else { ?>
		    	<td style="text-align: center;border-top: solid;border-bottom: solid;border-left: solid;border-right: solid">FPD <?php echo $peserta->ket ?></td>
		    <?php } ?>	
        </tr>                                                            
    </table>
    <?php $th = $peserta->tahun_pelajaran + 1; ?>
	<h3 style="text-align: center">FORMULIR PENDAFTARAN PESERTA DIDIK BARU<br>
